...
bool WZBackgroundSelector::IsFPPRegion() { return !zlep1IsTight() && zlep2IsTight() && lepton3IsTight(); }

bool WZBackgroundSelector::IsPFPRegion() { return zlep1IsTight() && !zlep2IsTight() && lepton3IsTight(); }

bool WZBackgroundSelector::IsPPFRegion() { return zlep1IsTight() && zlep2IsTight() && !lepton3IsTight(); }

bool WZBackgroundSelector::IsFPFRegion() { return !zlep1IsTight() && zlep2IsTight() && !lepton3IsTight(); }

bool WZBackgroundSelector::IsFFPRegion() { return !zlep1IsTight() && !zlep2IsTight() && lepton3IsTight(); }

bool WZBackgroundSelector::IsPFFRegion() { return zlep1IsTight() && !zlep2IsTight() && !lepton3IsTight(); }

bool WZBackgroundSelector::IsFFFRegion() { return !zlep1IsTight() && !zlep2IsTight() && !lepton3IsTight(); }
