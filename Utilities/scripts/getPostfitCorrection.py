...
def getComLineArgs():
    ...
    parser.add_argument("--postfit_file", type=str, required=True, help="Postfit file")
    parser.add_argument("-f", "--process", type=str, required=True, help="Name of process")
    parser.add_argument("--backgroundOnly", action="store_true", help="Use background only fit rather than s+b")
    parser.add_argument(
        "-c",
        "--channels",
    ...
    group.add_argument("--integral", action="store_true", help="Full normalization correction (across all bins)")
