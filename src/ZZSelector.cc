...
void ZZSelector::Init(TTree* tree) {
  ...
  systHists_ = {"yield",      "Mass",         "MassFull",     "nJets",        "nJets_central", "jetPt[1]",   "jetPt[0]",   "jetEta[0]",
                "jetEta[1]",  "absjetEta[0]", "absjetEta[1]", "mjj",          "dEtajj",        "Mass0j",     "Mass1j",     "Mass2j",
                "Mass3j",     "Mass34j",      "Mass4j",       "Mass0jFull",   "Mass1jFull",    "Mass2jFull", "Mass3jFull", "Mass34jFull",
  ...
  hists1D_ = {"yield",      "Z1Mass",     "Z2Mass",      "ZMass",         "Z1MassFull", "Z2MassFull",   "ZMassFull", "EleZMass",     "MuZMass",
              "LepPt",      "LepPtFull",  "ElePt",       "MuPt",          "LepPt1",     "LepPt2",       "LepPt3",    "LepPt4",       "LepPt1Full",
              "LepPt2Full", "LepPt3Full", "LepPt4Full",  "Z1LepPt",       "Z2LepPt",    "LepEta",       "EleEta",    "MuEta",        "Mass",
              "ZZPt",       "ZPt",        "nJets",       "nJets_central", "MassFull",   "CosTheta1",    "CosTheta2", "CosThetaStar", "RapidityDiff",
              "dPhiOSll",   "Mass0j",     "Mass1j",      "Mass2j",        "Mass3j",     "Mass34j",      "Mass4j",    "Mass0jFull",   "Mass1jFull",
              "Mass2jFull", "Mass3jFull", "Mass34jFull", "Mass4jFull",    "jetEta[0]",  "absjetEta[0]", "jetEta[1]", "absjetEta[1]", "jetPt[0]",
...
void ZZSelector::FillHistograms(Long64_t entry, std::pair<Systematic, std::string> variation) {
  ...
  if (isMC_) {
    for (size_t i = 0; i < lheWeights.size(); i++) {
      SafeHistFill(weighthistMap1D_, getHistName("ZMassFull", variation.second), Z1Mass, i, lheWeights[i] / lheWeights[0] * weight);
      SafeHistFill(weighthistMap1D_, getHistName("ZMassFull", variation.second), Z2Mass, i, lheWeights[i] / lheWeights[0] * weight);
      SafeHistFill(weighthistMap1D_, getHistName("Z1MassFull", variation.second), Z1Mass, i, lheWeights[i] / lheWeights[0] * weight);
      SafeHistFill(weighthistMap1D_, getHistName("Z2MassFull", variation.second), Z2Mass, i, lheWeights[i] / lheWeights[0] * weight);
    }
  }
  ...
  if (isMC_) {
    for (size_t i = 0; i < lheWeights.size(); i++) {
      ...
      if (channel_ == eeee) {
        SafeHistFill(weighthistMap1D_, getHistName("ElePt", variation.second), l1Pt, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("ElePt", variation.second), l2Pt, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("ElePt", variation.second), l3Pt, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("ElePt", variation.second), l4Pt, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("EleEta", variation.second), l1Eta, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("EleEta", variation.second), l2Eta, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("EleEta", variation.second), l3Eta, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("EleEta", variation.second), l4Eta, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("EleZMass", variation.second), Z1Mass, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("EleZMass", variation.second), Z2Mass, i, lheWeights[i] / lheWeights[0] * weight);
      } else if (channel_ == eemm) {
        SafeHistFill(weighthistMap1D_, getHistName("ElePt", variation.second), l1Pt, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("ElePt", variation.second), l2Pt, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("MuPt", variation.second), l3Pt, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("MuPt", variation.second), l4Pt, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("EleEta", variation.second), l1Eta, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("EleEta", variation.second), l2Eta, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("MuEta", variation.second), l3Eta, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("MuEta", variation.second), l4Eta, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("EleZMass", variation.second), Z1Mass, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("MuZMass", variation.second), Z2Mass, i, lheWeights[i] / lheWeights[0] * weight);
      } else if (channel_ == mmee) {
        SafeHistFill(weighthistMap1D_, getHistName("MuPt", variation.second), l1Pt, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("MuPt", variation.second), l2Pt, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("ElePt", variation.second), l3Pt, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("ElePt", variation.second), l4Pt, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("MuEta", variation.second), l1Eta, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("MuEta", variation.second), l2Eta, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("EleEta", variation.second), l3Eta, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("EleEta", variation.second), l4Eta, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("MuZMass", variation.second), Z1Mass, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("EleZMass", variation.second), Z2Mass, i, lheWeights[i] / lheWeights[0] * weight);
      } else {
        SafeHistFill(weighthistMap1D_, getHistName("MuPt", variation.second), l1Pt, i, lheWeights[i] / lheWeights[0] * weight);
        SafeHistFill(weighthistMap1D_, getHistName("MuPt", variation.second), l2Pt, i, lheWeights[i] / lheWeights[0] * weight);
      ...
      SafeHistFill(weighthistMap1D_, getHistName("Z1LepPt", variation.second), l1Pt, i, lheWeights[i] / lheWeights[0] * weight);
      SafeHistFill(weighthistMap1D_, getHistName("Z1LepPt", variation.second), l2Pt, i, lheWeights[i] / lheWeights[0] * weight);
      SafeHistFill(weighthistMap1D_, getHistName("Z2LepPt", variation.second), l3Pt, i, lheWeights[i] / lheWeights[0] * weight);
      SafeHistFill(weighthistMap1D_, getHistName("Z2LepPt", variation.second), l4Pt, i, lheWeights[i] / lheWeights[0] * weight);
      ...
      //SafeHistFill(weighthistMap1D_, getHistName("Lep1Iso", variation.second), l1Iso, i, lheWeights[i] / lheWeights[0] * weight);
      //SafeHistFill(weighthistMap1D_, getHistName("Lep2Iso", variation.second), l2Iso, i, lheWeights[i] / lheWeights[0] * weight);
      //SafeHistFill(weighthistMap1D_, getHistName("Lep3Iso", variation.second), l3Iso, i, lheWeights[i] / lheWeights[0] * weight);
      //SafeHistFill(weighthistMap1D_, getHistName("Lep4Iso", variation.second), l4Iso, i, lheWeights[i] / lheWeights[0] * weight);
      //SafeHistFill(weighthistMap1D_, getHistName("LepIso", variation.second), l1Iso, i, lheWeights[i] / lheWeights[0] * weight);
      //SafeHistFill(weighthistMap1D_, getHistName("LepIso", variation.second), l2Iso, i, lheWeights[i] / lheWeights[0] * weight);
      //SafeHistFill(weighthistMap1D_, getHistName("LepIso", variation.second), l3Iso, i, lheWeights[i] / lheWeights[0] * weight);
      //SafeHistFill(weighthistMap1D_, getHistName("LepIso", variation.second), l4Iso, i, lheWeights[i] / lheWeights[0] * weight);

      SafeHistFill(weighthistMap1D_, getHistName("CosTheta1", variation.second), CosTheta1, i, lheWeights[i] / lheWeights[0] * weight);
      SafeHistFill(weighthistMap1D_, getHistName("CosTheta2", variation.second), CosTheta2, i, lheWeights[i] / lheWeights[0] * weight);
      SafeHistFill(weighthistMap1D_, getHistName("CosThetaStar", variation.second), CosThetaStar, i, lheWeights[i] / lheWeights[0] * weight);
      SafeHistFill(weighthistMap1D_, getHistName("RapidityDiff", variation.second), RapidityDiff, i, lheWeights[i] / lheWeights[0] * weight);
      if (channel_ == eemm || channel_ == mmee) {
        SafeHistFill(weighthistMap1D_, getHistName("dPhiOSll", variation.second), dPhiOSll, i, lheWeights[i] / lheWeights[0] * weight);
      }
    }
  }
