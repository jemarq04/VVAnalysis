 ...
 */
#ifndef disambiguateFinalStatesZL_h
#define disambiguateFinalStatesZL_h
...
class disambiguateFinalStatesZL : public TSelector {
public :
  TTree          *fChain;
  ...
  disambiguateFinalStatesZL(TTree * /*tree*/ =0) : fChain(0), fBestCandidateEntryList(0), fCutFormula(0), fCurrentRun(-1), fCurrentEvt(-1) { }
  virtual ~disambiguateFinalStatesZL() { SafeDelete(fBestCandidateEntryList); SafeDelete(fCutFormula); }
  ...
  ClassDef(disambiguateFinalStatesZL,0);
