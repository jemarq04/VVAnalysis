...
def float2double(hist):
    if hist.ClassName() == "TH1D" or hist.ClassName() == "TH2D":
        ...
        raise ValueError("Bad hist, dummy")
    return new
...
parser.add_argument("-t", "--tightfr_file", type=str, default="data/fakeRate18Apr2017-3LooseLeptons-TightMuons.root")
parser.add_argument("-m", "--medfr_file", type=str, default="data/fakeRate18Apr2017-3LooseLeptons-MediumMuons.root")
...
pileupSF = ROOT.ScaleFactor(
    "pileupSF", "Run2016B-H 36.8/fb Pileup profile over RunIISpring16 MC Scale Factor, x=NTruePU"
)
...
if os.path.isfile(args.medfr_file):
    print("INFO: Adding medium fake rates to", output_file)
...
if os.path.isfile(args.tightfr_file):
    print("INFO: Adding tight fake rates to", output_file)
