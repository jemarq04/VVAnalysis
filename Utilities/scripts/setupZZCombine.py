...
sys.path.append("/".join([manager_path, manager_name, "Utilities/python"]))
# print(sys.path)
...
fileMap = {
    "2016": "/afs/cern.ch/user/u/uhussain/ZZ4lRun2HistFiles/Hists17Oct2019-ZZ4l2016_Moriond.root",
...
cardtool.setVariations(["CMS_eff_e", "CMS_RecoEff_e", "CMS_eff_m", "CMS_pileup"], exclude=["nonprompt", "data"])
...
for year in ["2016", "2017", "2018"]:
    ...
    for process in plot_groups:
        ...
        if process not in ["zzjj4l_ewk", "qqZZ_sherpa", "zzqjj4l_ewk", "nonprompt", "data"]:  # and False
            ...
            cardtool.addTheoryVar(
                process, "pdf_hessian" if year != "2016" else "pdf_mc", [1] + list(range(10, 111)), central=0
            )
