...
public:
  ...
  RooUnfoldResponse(
      Int_t nb, Double_t xlo, Double_t xhi, const char* name = 0, const char* title = 0);  // constructor -  simple 1D case with same binning, measured vs truth
  RooUnfoldResponse(
      Int_t nm, Double_t mlo, Double_t mhi, Int_t nt, Double_t tlo, Double_t thi, const char* name = 0, const char* title = 0);  // constructor -  simple 1D case
  ...
  RooUnfoldResponse(
      const TH1* measured, const TH1* truth, const TH2* response, const char* name = 0, const char* title = 0);  // create from already-filled histograms
  ...
  static Int_t GetBin(
      const TH1* h,
      Int_t i,
      Bool_t overflow = kFALSE);  // vector index (0..nx*ny-1) -> multi-dimensional histogram global bin number (0..(nx+2)*(ny+2)-1) skipping under/overflow bins
...
inline RooUnfoldResponse::RooUnfoldResponse() : TNamed() {
  // RooUnfoldResponse default constructor. Use Setup() to set values.
  Init();
}

inline RooUnfoldResponse::RooUnfoldResponse(const char* name, const char* title) : TNamed(name, title) {
  // RooUnfoldResponse default named constructor. Use Setup() to set values.
  Init();
}

inline RooUnfoldResponse::RooUnfoldResponse(const TString& name, const TString& title) : TNamed(name, title) {
  // RooUnfoldResponse default named constructor. Use Setup() to set values.
  Init();
}
...
inline TH1* RooUnfoldResponse::Hfakes() { return _fak; }
...
inline void RooUnfoldResponse::UseOverflow(Bool_t set) {
...
inline Int_t RooUnfoldResponse::FindBin(const TH1* h, Double_t x) {
