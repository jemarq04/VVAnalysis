...
combine_file = ROOT.TFile(
    "/eos/user/k/kelong/WZAnalysisData/CombineData/VBSselection_Tight-28Feb2018-TightFrom3MediumLeptons.root", "update"
)
plot_file = ROOT.TFile(
    "/eos/user/k/kelong/WZAnalysisData/HistFiles/VBSselection_Tight-28Feb2018-TightFrom3MediumLeptons.root", "update"
)
