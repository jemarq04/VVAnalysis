...
void ZZSelector::Init(TTree* tree) {
  ...
  hists1D_ = {"yield",       "Z1Mass",        "Z2Mass",    "ZMass",        "Z1MassFull", "Z2MassFull",   "ZMassFull",    "EleZMass",   "MuZMass",
              ...
              "LepPhi",      "ElePhi",        "MuPhi",     "LepEta",       "EleEta",     "MuEta",        "Mass",         "ZZPt",       "ZPt",
              "nJets",       "nJets_central", "MassFull",  "CosTheta1",    "CosTheta2",  "CosThetaStar", "RapidityDiff", "dPhiOSll",   "Mass0j",
              "Mass1j",      "Mass2j",        "Mass3j",    "Mass34j",      "Mass4j",     "Mass0jFull",   "Mass1jFull",   "Mass2jFull", "Mass3jFull",
              "Mass34jFull", "Mass4jFull",    "jetEta[0]", "absjetEta[0]", "jetEta[1]",  "absjetEta[1]", "jetPt[0]",     "jetPt[1]"};
...
void ZZSelector::ApplyScaleFactors() {
  ...
  if (channel_ == eeee) {
    ...
    if (eRecoSF_ != nullptr) {
      ...
      pt_e1 = std::max(pt_e1, EleRecoSF_MIN_PT_ + 0.01f);
      pt_e2 = std::max(pt_e2, EleRecoSF_MIN_PT_ + 0.01f);
      pt_e3 = std::max(pt_e3, EleRecoSF_MIN_PT_ + 0.01f);
      pt_e4 = std::max(pt_e4, EleRecoSF_MIN_PT_ + 0.01f);
      if (EleRecoSF_Name_.rfind("2023", 0) != std::string::npos) {
        ...
        if (EleRecoSF_Name_ != "2025Prompt" || GetEleRecoSFName(pt_e1) != "RecoBelow20")
          weight *= recoref->evaluate({EleRecoSF_Name_.c_str(), "sf", GetEleRecoSFName(pt_e1), l1Eta, pt_e1});
        if (EleRecoSF_Name_ != "2025Prompt" || GetEleRecoSFName(pt_e2) != "RecoBelow20")
          weight *= recoref->evaluate({EleRecoSF_Name_.c_str(), "sf", GetEleRecoSFName(pt_e2), l2Eta, pt_e2});
        if (EleRecoSF_Name_ != "2025Prompt" || GetEleRecoSFName(pt_e3) != "RecoBelow20")
          weight *= recoref->evaluate({EleRecoSF_Name_.c_str(), "sf", GetEleRecoSFName(pt_e3), l3Eta, pt_e3});
        if (EleRecoSF_Name_ != "2025Prompt" || GetEleRecoSFName(pt_e4) != "RecoBelow20")
...
void ZZSelector::FillHistograms(Long64_t entry, std::pair<Systematic, std::string> variation) {
  ...
  if (isMC_) {
    ...
    for (size_t i = 0; i < lheWeights.size(); i++) {
      ...
      if (channel_ == eeee) {
        ...
        SafeHistFill(weighthistMap1D_, getHistName("ElePhi", variation.second), l1Phi, i, lheweight);
        SafeHistFill(weighthistMap1D_, getHistName("ElePhi", variation.second), l2Phi, i, lheweight);
        SafeHistFill(weighthistMap1D_, getHistName("ElePhi", variation.second), l3Phi, i, lheweight);
        SafeHistFill(weighthistMap1D_, getHistName("ElePhi", variation.second), l4Phi, i, lheweight);
        ...
        SafeHistFill(weighthistMap1D_, getHistName("ElePhi", variation.second), l1Phi, i, lheweight);
        SafeHistFill(weighthistMap1D_, getHistName("ElePhi", variation.second), l2Phi, i, lheweight);
        SafeHistFill(weighthistMap1D_, getHistName("MuPhi", variation.second), l3Phi, i, lheweight);
        SafeHistFill(weighthistMap1D_, getHistName("MuPhi", variation.second), l4Phi, i, lheweight);
        SafeHistFill(weighthistMap1D_, getHistName("EleEta", variation.second), l1Eta, i, lheweight);
        SafeHistFill(weighthistMap1D_, getHistName("EleEta", variation.second), l2Eta, i, lheweight);
        ...
        SafeHistFill(weighthistMap1D_, getHistName("ElePt", variation.second), l3Pt, i, lheweight);
        SafeHistFill(weighthistMap1D_, getHistName("ElePt", variation.second), l4Pt, i, lheweight);
        SafeHistFill(weighthistMap1D_, getHistName("MuPhi", variation.second), l1Phi, i, lheweight);
        SafeHistFill(weighthistMap1D_, getHistName("MuPhi", variation.second), l2Phi, i, lheweight);
        SafeHistFill(weighthistMap1D_, getHistName("ElePhi", variation.second), l3Phi, i, lheweight);
        SafeHistFill(weighthistMap1D_, getHistName("ElePhi", variation.second), l4Phi, i, lheweight);
      ...
      SafeHistFill(weighthistMap1D_, getHistName("LepPhi", variation.second), l1Phi, i, lheweight);
      SafeHistFill(weighthistMap1D_, getHistName("LepPhi", variation.second), l2Phi, i, lheweight);
      SafeHistFill(weighthistMap1D_, getHistName("LepPhi", variation.second), l3Phi, i, lheweight);
      SafeHistFill(weighthistMap1D_, getHistName("LepPhi", variation.second), l4Phi, i, lheweight);
  ...
  if (channel_ == eeee) {
    ...
    SafeHistFill(histMap1D_, getHistName("ElePhi", variation.second), l1Phi, weight);
    SafeHistFill(histMap1D_, getHistName("ElePhi", variation.second), l2Phi, weight);
    SafeHistFill(histMap1D_, getHistName("ElePhi", variation.second), l3Phi, weight);
    SafeHistFill(histMap1D_, getHistName("ElePhi", variation.second), l4Phi, weight);
    ...
    SafeHistFill(histMap1D_, getHistName("ElePhi", variation.second), l1Phi, weight);
    SafeHistFill(histMap1D_, getHistName("ElePhi", variation.second), l2Phi, weight);
    SafeHistFill(histMap1D_, getHistName("MuPhi", variation.second), l3Phi, weight);
    SafeHistFill(histMap1D_, getHistName("MuPhi", variation.second), l4Phi, weight);
    SafeHistFill(histMap1D_, getHistName("EleEta", variation.second), l1Eta, weight);
    SafeHistFill(histMap1D_, getHistName("EleEta", variation.second), l2Eta, weight);
    ...
    SafeHistFill(histMap1D_, getHistName("ElePt", variation.second), l3Pt, weight);
    SafeHistFill(histMap1D_, getHistName("ElePt", variation.second), l4Pt, weight);
    SafeHistFill(histMap1D_, getHistName("MuPhi", variation.second), l1Phi, weight);
    SafeHistFill(histMap1D_, getHistName("MuPhi", variation.second), l2Phi, weight);
    SafeHistFill(histMap1D_, getHistName("ElePhi", variation.second), l3Phi, weight);
    SafeHistFill(histMap1D_, getHistName("ElePhi", variation.second), l4Phi, weight);
