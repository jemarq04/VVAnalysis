...
for var in vars:
    for chan in channels:
        ...
        h1, h2, h3 = (
            fin.Get(var + "_" + chanp + "NoConfusion"),
            fin.Get(var + "_" + chanp + "_ULFullNoConfusion"),
            fin.Get(var + "_" + chanp + "_ULEcalNoConfusion"),
        )

        max1 = max(h1.GetMaximum(), h2.GetMaximum(), h3.GetMaximum())

        min1 = min(h1.GetMinimum(), h2.GetMinimum(), h3.GetMinimum(), 0.0)
