...
combine_file = ROOT.TFile(
    "/eos/user/k/kelong/WZAnalysisData/CombineData/VBSselection_Tight-11Mar2018-TightFrom3MediumLeptons_JakobsControlPt30.root",
    "update",
)
plot_file = ROOT.TFile(
    "/eos/user/k/kelong/WZAnalysisData/HistFiles/VBSselection_Tight-11Mar2018-TightFrom3MediumLeptons_JakobsControlPt30.root",
    "update",
)
