...
public:
  ...
  RooUnfoldTUnfold(
      const RooUnfoldResponse* res, const TH1* meas, TUnfold::ERegMode reg = TUnfold::kRegModeDerivative, const char* name = 0, const char* title = 0);
  RooUnfoldTUnfold(const RooUnfoldResponse* res,
                   const TH1* meas,
                   Double_t tau,
                   TUnfold::ERegMode reg = TUnfold::kRegModeDerivative,
                   const char* name = 0,
                   const char* title = 0);
...
inline RooUnfoldTUnfold::RooUnfoldTUnfold() : RooUnfold() {
  // Default constructor. Use Setup() to prepare for unfolding.
  Init();
}

inline RooUnfoldTUnfold::RooUnfoldTUnfold(const char* name, const char* title) : RooUnfold(name, title) {
  // Basic named constructor. Use Setup() to prepare for unfolding.
  Init();
}

inline RooUnfoldTUnfold::RooUnfoldTUnfold(const TString& name, const TString& title) : RooUnfold(name, title) {
  // Basic named constructor. Use Setup() to prepare for unfolding.
  Init();
}

inline RooUnfoldTUnfold& RooUnfoldTUnfold::operator=(const RooUnfoldTUnfold& rhs) {
...
inline void RooUnfoldTUnfold::SetRegParm(Double_t parm) {
  // Set regularisation parameter (tau)
  FixTau(parm);
}

inline Double_t RooUnfoldTUnfold::GetTau() const {
  // Return regularisation parameter (tau)
  return _tau;
}

inline Double_t RooUnfoldTUnfold::GetRegParm() const {
  // Return regularisation parameter (tau)
  return _tau;
}

inline TUnfold::ERegMode RooUnfoldTUnfold::GetRegMethod() const { return _reg_method; }
