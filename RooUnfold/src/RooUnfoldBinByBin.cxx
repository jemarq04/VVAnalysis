...
RooUnfoldBinByBin::RooUnfoldBinByBin(const RooUnfoldBinByBin& rhs) : RooUnfold(rhs) {
  // Copy constructor.
  GetSettings();
}

RooUnfoldBinByBin::RooUnfoldBinByBin(const RooUnfoldResponse* res, const TH1* meas, const char* name, const char* title) : RooUnfold(res, meas, name, title) {
...
RooUnfoldBinByBin* RooUnfoldBinByBin::Clone(const char* newname) const {
  //!Clones object
...
TVectorD* RooUnfoldBinByBin::Impl() { return &_factors; }

void RooUnfoldBinByBin::Unfold() {
...
void RooUnfoldBinByBin::GetSettings() {
  _minparm = 0;
  _maxparm = 0;
  _stepsizeparm = 0;
  _defaultparm = 0;
