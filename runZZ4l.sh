...
for yr in $year; do
  ...
  #./Utilities/scripts/makeHistFile.py -f ZZ4l$yr -l $lumi -a ZZ4l$yr -s LooseLeptons --output_file "test$yr" --year $yr --uwvv -c eeee,eemm,mmee,mmmm -j 12 -sf --with_background -F HistFiles/fakeRate-ZZ4l$yr.root
